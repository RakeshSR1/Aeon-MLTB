...
BOT_TOKEN = "8016890106:AAECqZzikJ6DkXXSkEsNAKU5r9qVWUpwbMA" # Replace with your bot token
...
async def receive_file(bot, message):
    ...
    await message.reply(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("📤 Yes, Upload to GDrive", callback_data=f"gup_{message.id}")]]
        )
    )
